...
public class MusterijaManager extends JFrame {
	...
	public MusterijaManager() {
		...
		btnAddRow.setIcon(new ImageIcon(MusterijaManager.class.getResource("/butikracunara/plus-2x.png")));
		...
		btnDelRow.setIcon(new ImageIcon(MusterijaManager.class.getResource("/butikracunara/trash-2x.png")));
	...
	public void LoadTable() {
		String line;
		dtm.setRowCount(0);
        try (BufferedReader reader = new BufferedReader(new FileReader("musterije.csv"))) {
	...
	public void SaveTable() {
		 try (FileWriter writer = new FileWriter("musterije.csv")) {
