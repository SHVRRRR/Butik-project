...
public class NarudzbineManager extends JFrame {
	...
	public void LoadTable() {
		String line;
		dtm.setRowCount(0);
        try (BufferedReader reader = new BufferedReader(new FileReader("narudzbine.csv"))) {
	...
	public void SaveTable() {
		 try (FileWriter writer = new FileWriter("narudzbine.csv")) {
